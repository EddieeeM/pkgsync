...
Describe 'Test-PkgSyncConflict' {
    ...
    It 'returns true when targets point to different files' {
        Test-PkgSyncConflict -ExistingTarget 'C:\a\foo.exe' -CandidateTarget 'C:\b\foo.exe' | Should Be $true
    }
}
